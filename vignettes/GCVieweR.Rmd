...
GC_chart(ophA_clusters, group = "class", cluster = "cluster",
  ...
  GC_title("Adjusting Margins of a GC_chart", align = "left", y = 15, style = list(backgroundColor = "yellow", align = "left")) %>%
...
```{r echo=TRUE, results='asis'}
GC_chart(ophA_clusters, cluster = "cluster", group = "class", height = "130px") %>%
   GC_align(
     id_column = "class", 
     id = "NTF2-like",
