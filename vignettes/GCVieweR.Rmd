...
The `GC_grid()` function can be used to modify the grid of all or a specific cluster. In the below example the height and margins are adjusted for all clusters and subsequently adjusted for the first gene cluster.
...
GC_chart(ophA_clusters, group = "class", cluster = "cluster",
  ...
  GC_grid(margin = list(left = 50, right = 50)) %>%
  GC_grid(
    cluster = 1, 
    height = "50px",
