...
# Run nucmer
nucmer --prefix=seq1_seq2 seq1.fasta seq2.fasta

# Genome alignment mapping options
# one-to-one='-1'
# many-to-many='-m'
delta-filter -1 seq1_seq2.delta > seq1_seq2.delta
delta-filter -1 seq1_seq2.delta > seq1_seq2_one_to_one.delta
...
show-coords -H -T -r -k {seq1_seq2.delta} > {seq1_seq2.coords}
```
...
file_path <- "~/Desktop/phage/test.coords"
