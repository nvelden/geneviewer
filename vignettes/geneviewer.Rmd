...
It is possible to add an "identity" or "similarity" column to the data which will be used as measure to set the color intensity of the links. In addition links and labels can be styled using the `linkStyle` and `labelStyle` variable.
...
The `data` parameter can be used to load a data frame that specifies links between genomic regions based on their start and end positions, rather than linking specific genes.
