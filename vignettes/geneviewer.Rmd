...
It is possible to add an identity column to the data which will be used to set the color intensity of the links. In addition links and labels can be styled using the `linkStyle` and `labelStyle` variable.
